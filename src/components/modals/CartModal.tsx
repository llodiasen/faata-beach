          ...
          <div className="space-y-3">
            {filteredItems.map((item) => (
              ...
              >
                {/* Image produit */}
                {item.imageUrl ? (
                  <div className="w-24 h-24 rounded-xl overflow-hidden shadow-xl ring-2 ring-orange-200/50 flex-shrink-0">
                    <img
                      src={item.imageUrl}
                      alt={item.name}
                  ...
                  <div className="w-24 h-24 bg-gradient-to-br from-gray-200 to-gray-300 rounded-xl shadow-xl ring-2 ring-gray-300/50 flex items-center justify-center flex-shrink-0">
